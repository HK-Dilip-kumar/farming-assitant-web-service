...
<br><br><br><br>
     <div class="col-lg-6 m-auto" style="border:15px solid black">
		<form method="" action="" style="background-color:white">
			...
			<div class="from-group">
				...
				<input type="email" name="suppliername" id="suppliername" class="form-control">
			</div>
			<div class="from-group">
				<label for="email"><b>Supplier Address:</b></label>
				<input type="email" name="supplieraddress" id="" class="form-control">
			</div>
			<div class="from-group">
				<label for="email"><b>Mobile No:</b></label>
				<input type="email" name="suppliermobile" id="suppliermobile" class="form-control">
			</div>
			<div class="from-group">
				<label for="email"><b>Password:</b></label>
				<input type="password" name="supplierpassword" id="supplierpassword" class="form-control">
			</div>
			<div class="from-group">
				<label for="name"><b>Confirm Password:</b></label>
				<input type="password"  name="supplierconfirmpassword" id="supplierconfirmpassword" class="form-control">
			</div>
			<br>
