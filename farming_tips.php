...
<body>
  ...
  <nav>
      ...
      <li><a class="active" href="farming_tips.php">FARMING TIPS</a></li></LI>
      <li><a href="#">CONTACT FARMERS</a></li>
  </nav>

    <form action="tips_data.php" method="POST">
   
            <table style="margin-left: 40%;margin-top: 50px" >
              <tr>
                <td>Crop Name</td><td><input type="text" name="crop_name"></td>
              </tr>
              <tr>
              <td>Season</td><td><input type="text" name="season"></td>
              </tr>
              <tr>
              <td>Suggestion</td><td><input type="text" name="suggest"></td>
              </tr>
              <tr>
                <td align="center" style="padding: 9" colspan="2">
